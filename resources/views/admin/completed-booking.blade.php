...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a><i class="fa fa-angle-right"></i>Manage Completed Bookings</li>
            </ol>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Completed Bookings</h2>
						...
						<tbody>
<?php $sql = "SELECT *,bookingtbs.id as id from bookingtbs join tblwashingpoints on tblwashingpoints.id=bookingtbs.carWashPoint where status='New'";
