...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a><i class="fa fa-angle-right"></i>Add Washing Point </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  	       ...
  	       <h3>Add Washing Point</h3>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data" action="washpoint">
							@csrf
