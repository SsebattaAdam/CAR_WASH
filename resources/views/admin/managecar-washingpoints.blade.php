...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a><i class="fa fa-angle-right"></i>Manage Car Washing Points</li>
            </ol>
...
{				?>		
						  <tr>
							...
							<td>
								<a href="/editcar-washpoint?wpid=<?php echo htmlentities($result->id);?>">Edit</a> | <a href="/managecar-washingpoints?rid=<?php echo htmlentities($result->id);?>" style="color:red;" onClick="return confirm('Do you really want to delete');">Delete</a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
